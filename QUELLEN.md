...
Alle liegen als 4:3 quer, 1200 × 900, damit die Bildreihe gerade bleibt.
Wie man weitere hinzufügt, steht in `UEBERGABE.md`.

Die vier `ort-`Bilder zeigen **Situationen, keine Porträts**: das Mikrofon
über der Spalte, die Angel gegen den Wind. Fotos von jemandem beim
Aufnehmen kippen sonst schnell ins Werbliche — was hier trägt, ist die
Arbeit, nicht die Person.
